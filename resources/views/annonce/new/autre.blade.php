                                ...
                                <div id="contenu">
                                    <div class="nk-block-head">
                                        <div class="nk-block-head-content">
                                            <h4 class="nk-block-title">Autres</h4>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label class="form-label" for="default-textarea">Photo(s)</label>
...
<script src="{{asset('assets/js/app/js/annonce/new/autre.js') }}"></script>
