                                ...
                                <div>
                                    <div class="nk-block-head">
                                        <div class="nk-block-head-content">
                                            <h4 class="nk-block-title">Véhicules</h4>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-lg-3 col-md-6">
                                           <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    ...
                                                    <input type="text" class="form-control" id="km" placeholder="Input placeholder" >
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                           <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    ...
                                                    <input type="text" class="form-control" id="prix" placeholder="Input placeholder">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-6">
...
<script src="{{asset('assets/js/app/js/annonce/new/vehicule.js') }}"></script>
