                        ...
                        <table class="datatable-init nk-tb-list nk-tb-ulist" data-auto-responsive="false">
                            ...
                            <tbody>
                                <tr class="nk-tb-item">
                                    ...
                                    <td class="nk-tb-col ">
                                        <a href="" class="btn btn-sm btn-white btn-dim btn-outline-warning d-none d-md-inline-flex">
                                            <em class="icon ni ni-eye"></em>
                                            <span>Détail</span>
                                        </a>
                                        <a href="" class="btn btn-sm btn-icon btn-white btn-dim btn-outline-warning d-inline-flex d-md-none">
                                            <em class="icon ni ni-eye"></em>
                                        </a>
                                    </td>
                                </tr>
