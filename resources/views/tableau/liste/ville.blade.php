                    ...
                    <div class="col-lg-6">
                        <div class="card h-100">
                            <div class="card-inner">
                                ...
                                <form id="form" action="{{route('new_ville')}}" class="" method="post">
                                    @csrf
                                    <div class="mb-4" id="ville_container" >
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                                <input name="ville_new[]" class="form-control" required type="text" oninput="this.value = this.value.toUpperCase()" autocomplete="off" placeholder="Entrer le nom de la ville"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row g-gs">
                                        <div class="col-6 text-center">
                                            <a class="btn btn-mw btn-dim btn-outline-warning " id="ajouter_ville">
